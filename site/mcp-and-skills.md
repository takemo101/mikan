...
The installed guidance is intentionally compact: it teaches a board-first operating loop, MCP-first operation with CLI fallback, single-project and workspace Repository rules, advisory dependencies, one-way GitHub Mirror boundaries, and local-first scope.
